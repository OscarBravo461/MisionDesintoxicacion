...
public class Player_3 : MonoBehaviour {
    ...
    Vector3 SectorEscuela = new Vector3(-7.68f, 4.15f, 0f);
    Vector3 SectorCiudad = new Vector3(8.74f, 3.61f, 0f);
    Vector3 SectorPlaza = new Vector3(-16.29f, -5.46f, 0f);
    Vector3 SectorParque = new Vector3(27.02f, -9.94f, 0f);
