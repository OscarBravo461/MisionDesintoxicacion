...
public class Player_4 : MonoBehaviour {
    ...
    Vector3 SectorEscuela = new Vector3(-13.17f, 4.19f, 0f);
    Vector3 SectorCiudad = new Vector3(11.31f, 3.61f, 0f);
    Vector3 SectorPlaza = new Vector3(-13.45f, -5.49f, 0f);
    Vector3 SectorParque = new Vector3(21.63f, -9.91f, 0f);
