...
public class Player_2 : MonoBehaviour
{
    ...
    Vector3 SectorEscuela = new Vector3(-7.67f, 5.93f, 0f);
    Vector3 SectorCiudad = new Vector3(11.18f, 5.07f, 0f);
    Vector3 SectorPlaza = new Vector3(-13.63f, -3.69f, 0f);
    Vector3 SectorParque = new Vector3(27.09f, -8.31f, 0f);
